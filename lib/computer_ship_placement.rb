...
class ComputerShipPlacement
  ...
  def second_boat_placement
    ...
    if direction_boat_2 == 0
      ...
      # elsif @computer_board[boat_2_start_row][boat_2_start_index] == " . " && @computer_board[boat_2_start_row][boat_2_start_index - 1] == " . " && @computer_board[boat_2_start_row][boat_2_start_index + 1] == " . "
      #   @computer_board[boat_2_start_row][boat_2_start_index] = " B "
      #   @computer_board[boat_2_start_row][boat_2_start_index - 1] = " B "
      #   @computer_board[boat_2_start_row][boat_2_start_index + 1] = " B "
      # elsif @computer_board[boat_2_start_row][boat_2_start_index] == " . " && @computer_board[boat_2_start_row][boat_2_start_index - 1] == " . " && @computer_board[boat_2_start_row][boat_2_start_index - 2] == " . "
      #   @computer_board[boat_2_start_row][boat_2_start_index] = " B "
      #   @computer_board[boat_2_start_row][boat_2_start_index - 1] = " B "
      #   @computer_board[boat_2_start_row][boat_2_start_index - 2] = " B "
      else
      ...
      if @computer_board[boat_2_start_row][boat_2_start_index] == " . " && @computer_board[boat_2_start_row + 1][boat_2_start_index] == " . " && @computer_board[boat_2_start_row + 2][boat_2_start_index] == " . "
        @computer_board[boat_2_start_row][boat_2_start_index] = " B "
        @computer_board[boat_2_start_row + 1][boat_2_start_index] = " B "
        @computer_board[boat_2_start_row + 2][boat_2_start_index] = " B "
      # elsif @computer_board[boat_2_start_row][boat_2_start_index] == " . " && @computer_board[boat_2_start_row -1 ][boat_2_start_index] == " . " && @computer_board[boat_2_start_row + 1][boat_2_start_index] == " . "
      #   @computer_board[boat_2_start_row][boat_2_start_index] = " B "
      #   @computer_board[boat_2_start_row - 1][boat_2_start_index] = " B "
      #   @computer_board[boat_2_start_row + 1][boat_2_start_index] = " B "
      # elsif @computer_board[boat_2_start_row][boat_2_start_index] == " . " && @computer_board[boat_2_start_row -1 ][boat_2_start_index] == " . " && @computer_board[boat_2_start_row -2 ][boat_2_start_index] == " . "
      #   @computer_board[boat_2_start_row][boat_2_start_index] = " B "
      #   @computer_board[boat_2_start_row - 1][boat_2_start_index] = " B "
      #   @computer_board[boat_2_start_row - 2][boat_2_start_index] = " B "
      else
